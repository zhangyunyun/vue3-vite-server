module.exports = () => {
    return {
        ...
        banner: [{
                imgUrl: '/imgs/index_page/transformer-banner1.png'
            },
            {
                imgUrl: '/imgs/index_page/transformer-banner2.png'
            }
        ],
        transformer: [{
                label: '美食外卖',
        ...
        scrollBarInfo: [{
            ...
            },
            {
                type: 'youhuiquan',
                badge: '优惠券',
                detail: `你有<span class="info-num">4</span>张总<span class="info-num">43.5</span>优惠券即将到期`,
                btn: '去查看',
            }
        ],
        countdown: {
        ...
        activities: [{
                imgUrl: '/imgs/index_page/activity/01.png'
            },
            {
                imgUrl: '/imgs/index_page/activity/02.png'
            },
            {
